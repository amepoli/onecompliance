...
if __name__ == "__main__":
    input_file = '/home/apoli/Development/onecompliance/dynamo-tables/views/fornitori_dati_associati_sub_of_fornitori.json'  # Inserisci il path del file di input
    main(input_file)
