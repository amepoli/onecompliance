...
LAMBDANAME=`cat ../../${1}.json | jq -r ".lambdas.users.lambdaName"`
...
DYN_TRANSLATIONNAME=`cat ../../${1}.json | jq -r ".dynamoTables.translation.tableName"`
...
BUCKETNAME=`cat ../../${1}.json | jq -r ".lambdas.users.s3.bucket"`
