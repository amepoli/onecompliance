        ...
        if (requestType === 'getGoogleDriveFileCopyParams') {
            ...
            if (requestType === 'getFileList') {
                ...
                if (bus_object == 'cdms_risorse_revisioni') {
                    ...
                    client_file_name=substr(replace('${datarif}','-',''),0,9)||'_'||'${replaceAll(requestBody.nickname, "'", "''")}', content_type='${requestBody.content_type}', dimensione=${requestBody.dimensione},
                    ...
                    if (filesCount > 0) {
                        ...
                        if (checksum === actualChecksum) { // file correctly uploaded
                            ...
                            query = `insert into entrasp.cdms_risorse_revisioni (codice_azienda, id_risorsa, prog_revisione, data_creazione, file_id, 
                                    ...
                                    '${requestBody.autore}', substr(replace('${datarif}','-',''),0,9)||'_'||'${replaceAll(requestBody.nickname, "'", "''")}', '${requestBody.content_type}', ${dimensione}, 
