...
const scripts = {
    ...
    checkStatus: `select csn.codice_compito, csn.date_time_begin, csn.codice_azienda, entrasp.compito_titolo(csn.codice_azienda, csn.codice_compito) as description, 
