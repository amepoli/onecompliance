...
exports.handler = async (event, context) => {
  ...
  //Generate encodedToken for Basic auth
  ...
  for (let i = 0; i < connectedRegistries.length; i++) {
    ...
    console.log('Inizio scannerizzazione ', i + 1);
    ...
    console.log('After stringify: ', postData_getScan);
    ...
    console.log('scannedData: ', i + 1 + ' - ', scannedData.data);
