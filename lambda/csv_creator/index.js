...
async function writeFileToS3(key, data, bucket = default_bucket_name) {
...
async function processQueryParams(queryParams) {
    ...
    let bucket = queryParams.bucket ? queryParams.bucket : default_bucket_name; //bucket_name ? bucket_name : default_bucket;
