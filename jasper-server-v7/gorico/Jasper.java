...
public class Jasper {
    ...
    public void fill(String locale) throws Exception {
        ...
        parameterMap.put(JRParameter.REPORT_LOCALE, Locale.of(locale));
    ...
    public String createReportUsingJasperData(JasperData data) {
        try {
            ...
            // Load locale
            String locale = (data.locale != null && !data.locale.trim().isEmpty()) ? data.locale
                    : Constants.LOCALIZATIONS_DEFAULT;
            ...
            // Load the locale
            params.put(JRParameter.REPORT_LOCALE, Locale.of(locale));
