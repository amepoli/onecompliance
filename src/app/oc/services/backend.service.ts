...
export class BackendService {
  ...
  getProfileData(company: string): Observable<any> {
    ...
    return from(this.awsService.api().get(this.apiName, this.tablesApiName, this.myGetInit));
  }
  ...
  deleteData(entryName: string, company: string, keys: any): Observable<any> {
    this.awsService.auth();
    this.myGetInit.queryStringParameters = { entry_name: entryName, company: company, keys: JSON.stringify(keys) };
    return from(this.awsService.api().del(this.apiName, this.tablesApiName, this.myGetInit));
  }
  ...
  loadFileDataIfExists(entryName: string, company: string, keys: any, checksum: string, md5Checksum: string): Observable<any> {
    ...
    return from(this.awsService.api().post(this.apiName, this.attachApiName, this.myPutPostInit));
  }
  ...
  deleteFile(entryName: string, company: string, id_risorsa: string, filename: string, prog_revisione: string, keys: any): Observable<any> {
    ...
    return from(this.awsService.api().del(this.apiName, this.attachApiName, this.myGetInit));
  }
  ...
  getReportList(entryName: string, company: string, keys: any, isFormView: boolean): Observable<any> {
    ...
    return from(this.awsService.api().get(this.apiName, this.reportsApiName, this.myGetInit));
  }
  ...
  getReport(entryName: string, company: string, keys: any, reportName: string, isFormView: boolean, search_keys: any): Observable<any> {
    ...
    return from(this.awsService.api().post(this.apiName, this.reportsApiName, this.myPutPostInit));
  }
  ...
  getMenu(keys: any): Observable<any> {
    ...
    return from(this.awsService.api().get(this.apiName, this.menuApiName, this.myGetInit));
  }

  getLanguage(lang: string): Observable<any> {
    this.awsService.auth();
    this.myGetInit.queryStringParameters = { lang: lang };
    return from(this.awsService.api().get(this.apiName, this.langApiName, this.myGetInit));
  }
  ...
  createImportFileURL(): Observable<any> {
    ...
    return from(this.awsService.api().post(this.apiName, this.importApiName, this.myPutPostInit));
  }
  ...
  importS3ToRDS(table: string): Observable<any> {
    ...
    return from(this.awsService.api().post(this.apiName, '/S3ToRDS', this.myPutPostInit));
  }

  sendEmailUsingTemplate(templateKey: string): Observable<any> {
    this.awsService.auth();
    this.myPutPostInit.queryStringParameters = { templateKey: templateKey };
    return from(this.awsService.api().get(this.apiName, this.emailApiName, this.myPutPostInit));
  }
  ...
  sendEmail(subject: string, header: string, footer: string, company: string, sender: string, to: string, cc: string, ccn: string): Observable<any> {
    ...
    return from(this.awsService.api().post(this.apiName, this.emailApiName, this.myPutPostInit));
  }
  ...
  isTrDayComplete(username: string, date_time: string): Observable<any> {
    ...
    return from(this.awsService.api().get(this.apiName, this.timeTrackerApiName, this.myGetInit));
  }
  ...
  updateArchiflow(numRecords: number): Observable<any> {
    ...
    return from(this.awsService.api().get(this.apiName, this.archiflowApiName, this.myGetInit));
  }
  ...
  saveAuthToken(token_type: string, authCode: any) {
    ...
    return from(this.awsService.api().post(this.apiName, this.googleApiName, this.myPutPostInit));
  }

  loadAuthToken(token_type: string) {
    this.awsService.auth();
    this.myGetInit.queryStringParameters = { request_type: 'loadAuthToken', token_type: token_type };
    return from(this.awsService.api().get(this.apiName, this.googleApiName, this.myGetInit));
  }
  ...
  syncDriveS3File(syncData: object, syncMode: string, authToken: any) {
    this.awsService.auth();
    this.myPutPostInit.queryStringParameters = { request_type: 'syncDriveS3File', syncData: JSON.stringify(syncData), syncMode: syncMode };
    this.myPutPostInit.body = authToken;
    return from(this.awsService.api().post(this.apiName, this.googleApiName, this.myPutPostInit));
  }
  ...
  getConnectedRegistries(company: string, registry: string): Observable<any> {
    ...
    return from(this.awsService.api().get(this.apiName, this.regulatVPCApiName, this.myGetInit));
  }
  ...
  getAmlScan(company: string, connected_registries: any, checkId: string, dynamoUser: string, isLightScan: boolean): Observable<any> {
    ...
    return from(this.awsService.api().get(this.apiName, this.regulatApiName, this.myGetInit));
  }
