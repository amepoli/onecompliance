...
@Component({
  selector: "app-label",
  template: `
  <div *ngIf="field.isVisible != false" [ngStyle]="{ 'background-color': field.style.background_color? field.style.background_color: 'transparent', 'border-radius':'4px', 'padding': '8px', 'margin-bottom': '24px', 'margin-right': '1%', 'margin-left': '1%','width': field.width+'%'}" appearance="outline" [formGroup]="group">
