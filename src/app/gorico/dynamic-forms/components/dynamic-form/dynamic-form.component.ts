...
@Component({
  ...
  template: `
  <form style="margin-left: 1%; margin-right: 1%; width: 98%;" [style.background-color]="isQuickAdd? 'lightyellow': 'transparent'" class='dynamic-form' [id]='formName' [formGroup]='form' (submit)='onSubmit($event)'>
