...
import { OCSingleFieldComponent } from './oc-single-field.component';
...
const meta: Meta<OCSingleFieldComponent> = {
  title: 'Example/OCSingleField',
  component: OCSingleFieldComponent,
  ...
  // decorators: [
  //   moduleMetadata({
  //     // inputs: ['fields', 'formName', 'readOnlyPage', 'isQuickAdd'],
  //     imports: [
  //       // // CommonModule,
  ...
  //       //     // FormsModule,
  //       //     DynamicFormsModule,
  //       //     DynamicFormComponent], // DynamicFormsModule],
...
export default meta;
type Story = StoryObj<OCSingleFieldComponent>;


export const user_upd: Story = {
  args: {
    field:   {
    table: "progetti",
    label: "",
...
export const reopen_progetto_k: Story = {
  args: {
    field:   {
    table: "progetti",
...
export const progettolabel: Story = {
  args: {
    field:   {
    table: "progetti",
    label: "Progetto",
...
export const data_inserimento: Story = {
  args: {
    field:     {
    table: "progetti",
    label: "Data ins",
...
export const invisible_2: Story = {
  args: {
    field:     {
    table: "progetti",
    label: "invisible_2",
...
export const progetti_actions: Story = {
  args: {
    field:     {
    table: "progetti",
    label: " ",
...
export const codice_progetto: Story = {
  args: {
    field:     {
    table: "progetti",
    label: "Codice",
...
export const id_progetto: Story = {
  args: {
    field:     {
    table: "progetti",
    label: "# Progetto",
...
export const attivita_vr: Story = {
  args: {
    field:     {
    table: "progetti",
    label: "Vers.",
...
export const foreseen_date: Story = {
  args: {
    field:     {
    table: "progetti",
...
export const id_contratto: Story = {
  args: {
    field:     {
    table: "progetti",
    label: "Contratto",
...
export const codice_part: Story = {
  args: {
    field:     {
    table: "progetti",
    label: "Codice Part",
...
export const codice_azienda: Story = {
  args: {
    field:     {
    table: "progetti",
    label: "Azienda",
...
export const id_centro_gest: Story = {
  args: {
    field:     {
    table: "progetti",
...
export const id_anagrafica_assegnataria: Story = {
  args: {
    field:     {
    table: "progetti",
    label: "Assegnatario",
...
export const data_competenza: Story = {
  args: {
    field:     {
    table: "progetti",
...
export const codice_attivita: Story = {
  args: {
    field:     {
    table: "progetti",
...
export const id_argomento: Story = {
  args: {
    field:     {
    table: "progetti",
    label: "Argomento",
...
const meta: Meta<OCSingleFieldComponent> = {
  ...
  render: (
    // args: OCSingleFieldComponent
  ) => ({
    // props: {
    //   ...args,
    // },
    // template: `<storybook-oc-single-field ${argsToTemplate(
    //   args
    // )}></storybook-oc-single-field>`,
    template: `<storybook-oc-single-field></storybook-oc-single-field>`,
  }),
};
